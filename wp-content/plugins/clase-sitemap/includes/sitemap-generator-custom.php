...
echo '<a class="exitbutton" href="' . $rutita . '/alberto-palazuelos-posts.xml" target="_blank">Comprobar Sitemap</a>';
$domblog->save('alberto-palazuelos-posts.xml') or die('XML Create Error');
?>
...
if (empty($canonical) || $canonical === get_permalink()) {
    if (in_array('all', $metarobots) || in_array('index', $metarobots)) {
    $enlace = get_permalink();
    $lastestmod = get_the_modified_date('Y-m-d');
...
echo '<a class="exitbutton" href="' . $rutita . '/alberto-palazuelos-page.xml" target="_blank">Comprobar Sitemap</a>';
$dompage->save('alberto-palazuelos-page.xml') or die('XML Create Error');
?>
...
echo '<a class="exitbutton" href="' . $rutita . '/alberto-palazuelos-noticia.xml" target="_blank">Comprobar Sitemap</a>';
$domnoticia->save('alberto-palazuelos-noticia.xml') or die('XML Create Error');
?>
